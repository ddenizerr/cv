<div class="row mb-5">
    <div class="font-monospace d-flex justify-content-center">
        <div class="col-lg-4 col-sm-6 d-flex justify-content-center">
            <h5 class="glow fs-6">select your character to start</h5>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="card-avatar">
                                <img src="/images/deniz-memoji.jpeg" alt="Casual-Avatar" class="card-avatar">
                            </div>
                        </div>
                        <div class="row">
            ...
            <a href="{{route('career.index')}}" class="disabled text-decoration-none">
                <div class="card glow-card">
                    <div class="card-body ">
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="card-avatar">
                                <img src="/images/deniz-corporate.jpeg" alt="Casual-Avatar" class="card-avatar">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col d-flex justify-content-center">
